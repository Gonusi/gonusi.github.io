---
title: Learn pen shading with leafy shapes, varnishing large surfaces, some print CSS styles. 
description: A tough day but a nice one
layout: layout.html
tags: ["til"]
date: 2026-01-29
---
...
![Almost finished base book shelf](shelf1.resized.jpg)

![Almost finished base book shelf](shelf2.resized.jpg)
...
![shading with leafy shapes](shading.resized.jpg)
...
1. it's indeed possible to detect "closing of print dialog":

```js
window.print()
window.addEventListener('afterprint', handleAfterPrint) // nice
```
