/*!
 *   matter-js 0.14.2-alpha+172a9cc by @liabru (c) 2020-03-11
 *   Experimental pre-release build.
 *   http://brm.io/matter-js/
 *   License MIT
 */
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object") module.exports = factory(require("poly-decomp"));
  else if (typeof define === "function" && define.amd) define("Matter", ["poly-decomp"], factory);
  else if (typeof exports === "object") exports["Matter"] = factory(require("poly-decomp"));
...
*/
        ...
        (function () {
          ...
          Body.update = function (body, deltaTime, timeScale, correction) {
            ...
            body.angularVelocity =
              (body.angle - body.anglePrev) * frictionAir * correction + (body.torque / body.inertia) * deltaTimeSquared;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        (function () {
          ...
          Constraint.create = function (options) {
            ...
            constraint.angleA = typeof constraint.angleA !== "undefined" ? constraint.angleA : constraint.bodyA ? 0 : angle;
            ...
            constraint.angleB = typeof constraint.angleB !== "undefined" ? constraint.angleB : constraint.bodyB ? 0 : angle;
          ...
          Constraint.solve = function (constraint, timeScale) {
            ...
            var difference = (currentLength - constraint.length) / currentLength,
              ...
              angleAStiffness =
                (constraint.angleAStiffness < 1 ? constraint.angleAStiffness * timeScale : constraint.angleAStiffness) *
                Constraint._angleLimitDampen,
              angleBStiffness =
                (constraint.angleBStiffness < 1 ? constraint.angleBStiffness * timeScale : constraint.angleBStiffness) *
                Constraint._angleLimitDampen,
              torque,
              share,
              normal,
            ...
            if (constraint.angleBStiffness) {
              angleLimitPointB = Constraint.solveAngleLimits(
                ...
                bodyB,
                constraint.angleB,
                constraint.angleBMin,
                constraint.angleBMax,
                delta,
                1,
                currentLength,
                pointBWorld,
           ...
           */
          Constraint.solveAngleLimits = function (
            constraint,
            body,
            angle,
            angleMin,
            ...
            for (var i = 0; i < constraints.length; i++) {
              ...
              if (constraint.render.angles && constraint.angleAStiffness) {
                ...
                c.arc(
                  ...
                  start.y,
                  12,
                  relativeAngle + constraint.angleAMin,
                  relativeAngle + constraint.angleAMax + 0.0001,
              ...
              if (constraint.render.angles && constraint.angleBStiffness) {
                ...
                c.arc(
                  ...
                  12,
                  relativeAngle + constraint.angleBMin,
                  relativeAngle + constraint.angleBMax + 0.0001,
                  constraint.angleBMin <= constraint.angleBMax
                );
                c.lineTo(end.x, end.y);
                c.closePath();
                ...
                for (col = union.startCol; col <= union.endCol; col++) {
                  for (row = union.startRow; row <= union.endRow; row++) {
                    ...
                    var isInsideNewRegion =
                      col >= newRegion.startCol && col <= newRegion.endCol && row >= newRegion.startRow && row <= newRegion.endRow;

                    var isInsideOldRegion =
                      col >= body.region.startCol && col <= body.region.endCol && row >= body.region.startRow && row <= body.region.endRow;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        (function () {
          ...
          Bodies.fromVertices = function (x, y, vertexSets, options, flagInternal, removeCollinear, minimumArea) {
            var decomp = global.decomp || __webpack_require__(27),
              body,
              parts,
              isConvex,
              vertices,
            ...
            for (var i = 0; i < pairs.length; i++) {
              ...
              for (var j = 0; j < contacts.length; j++) {
                ...
                var oAcN = Vector.cross(offsetA, normal),
                  ...
                  share =
                    contactShare /
                    (bodyA.inverseMass + bodyB.inverseMass + bodyA.inverseInertia * oAcN * oAcN + bodyB.inverseInertia * oBcN * oBcN);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        (function () {
           ...
           * @type {String}
           */
          Matter.version = true ? "0.14.2-alpha+172a9cc" : undefined;
